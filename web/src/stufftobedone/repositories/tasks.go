...
func (r *TaskRepository) Search(bookID string, search string) ([]domain.Task, error) {
	tasks := []domain.Task{}
	...
	q := datastore.NewQuery("Tasks").Filter("ProjectID =", "").Filter("Search =", false).Filter("IsDeleted =", false).Order("Created")
